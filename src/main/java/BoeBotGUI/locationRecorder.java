...
public class locationRecorder {
    ...
    public void setGoatFeedCoords(double xCoord, double yCoord) {
        goatFeedXCoord = (int)xCoord;
        goatFeedYCoord = (int)yCoord;
    }
    ...
    public int getGoatFeedYCoord() {
        return goatFeedYCoord;
    }

    public int getStartingPointXCoord() {
        return startingPointXCoord;
    }

    public int getStartingPointYCoord() {
        return startingPointYCoord;
    }
}
